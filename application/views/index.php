...
<a id="top"></a>
<!-- TOP button -->
<a href="<?php echo BASE; ?>#top" class="btn-large btn-floating waves-effect waves-light  blue-grey darken-4"
   id="top_arrow" title="TOP">
        ...
        <div class="container">
            ...
            <form class="row center" action="<?php echo BASE . "search"; ?>">
                ...
                <div class="col-xs-12 col-sm-8 col-sm-offset-1" style="margin-bottom:10px;">
                    <input placeholder="Search Tutors: Mathematics, Physics, Science etc." type="search"
            ...
            <ul class="nav navbar-nav" id="homeDropdown">
                <?php foreach ($cst as $class_id => $class) : ?>
                    <li><a href="<?php echo HOST . 'search/' . $class['name']; ?>"><?php echo $class['name']; ?> <span
                                class="caret"></span></a>
                        <ul class="dropdown-menu multi-level">
                            <?php foreach ($class['children'] as $subject_id => $subject) : ?>
                                <li>
                                    <a href="<?php echo HOST . 'search/' . $class['name'] . '/' . $subject['name']; ?>"><?php echo $subject['name']; ?>
                                        <span class="caret"></span></a>
                                    <ul class="dropdown-menu">
                                        <?php foreach ($subject['children'] as $topic_id => $topic) : ?>
                                            <li>
                                                <a href="<?php echo HOST . 'search/' . $class['name'] . '/' . $subject['name'] . '/' . str_replace(' ', '_', $topic['name']); ?>"><?php echo $topic['name']; ?></a>
                                            </li>
                                        <?php endforeach; ?>
                                    </ul>
                                </li>
...
<div id="welcome" class="modal modal-fixed-footer">
    <div class="modal-content">
        ...
        <p>
            Have a <b>doubt</b>? Need <b>personal</b> tuition? Please enter the details below &amp; we will revert
            within 24 Hours.
        </p>
            ...
            <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" id="class" name="class"
                                   placeholder="9th/IIT JEE/Electrical/MBA prep">
                        </div>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <textarea class="form-control" rows="8" col="5" id="msg" name="msg"
                                  placeholder="I need help in my upcoming math exam in a month. I am free on saturdays and sundays."></textarea>
                    </div>
                </div>
            </div>
        </form>
                        ...
                        <li>
                            <div class="row">
                                ...
                                <div class="col-xs-4 teacher">
                                    <img class="img-responsive circle"
                                         src="<?php echo $reviews[$rand[$i]]['profilepic']; ?>">
                                    <span
                                        class="grey-text text-darken-2"><?php echo ucwords($reviews[$rand[$i]]['teacher']); ?></span>
                                </div>
                            </div>
                        </li>
                    <?php } ?>
...
<div class="jumbotron">
    <div class="container">
        ...
        <div class="row center">
            <div class="col-xs-12">
                <a href="<?php echo BASE . 'search'; ?>" class="hoverable course-link">Chemical Reaction &amp;
                    Equations</a>
                ...
                <a href="<?php echo BASE . 'search'; ?>" class="hoverable course-link">Some Basic Concepts of
                    Chemistry</a>
                ...
                <a href="<?php echo BASE . 'search'; ?>" class="hoverable course-link">Electrostatic potential and
                    Charge</a>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-5">
                <br>
                <a class="valign btn-large waves-effect waves-light attention-joinus"
                   href="<?php echo BASE . 'joinus'; ?>">Join Us</a>
                <br>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col s12">
                <div id="slider1_container" style="position: relative; height: 70px; overflow: hidden; ">
                    <div u="slides"
                         style="cursor: move; position: relative; width:1340px; height: 70px; overflow: hidden;">
                        <div><a target="_blank" href="http://www.iitgn.ac.in/"><img src="logos/IITGandhinagar.png"
                                                                                    title="IIT Gandhinagar" height="70"
                                                                                    width="70"></a></div>
                        <div><a target="_blank" href="http://www.iitr.ac.in"><img src="logos/roorkee.png"
                                                                                  title="IIT Roorkee" height="70"
                                                                                  width="70"></a></div>
                        <div><a target="_blank" href="http://www.iitmandi.ac.in"><img src="logos/mandi-iit.png"
                                                                                      title="IIT Mandi" height="70"
                                                                                      width="70"></a></div>
                        <div><a target="_blank" href="http://www.iiti.ac.in"><img src="logos/indore.png"
                                                                                  title="IIT Indore" height="70"
                                                                                  width="70"></a></div>
                        <div><a target="_blank" href="http://www.iitj.ac.in"><img src="logos/IIT-JODHPUR-LOGO.png"
                                                                                  title="IIT Jodhpur" height="70"
                                                                                  width="70"></a></div>
                        <div><a target="_blank" href="http://www.iitg.ac.in"><img src="logos/IIT-Guwahati-Logo.png"
                                                                                  title="IIT Guwahati" height="70"
                                                                                  width="70"></a></div>
                        <div><a target="_blank" href="http://www.iitd.ac.in"><img src="logos/iit-delhi.png"
                                                                                  title="IIT Delhi" height="70"
                                                                                  width="70"></a></div>
                        <div><a target="_blank" href="http://www.iitb.ac.in"><img src="logos/iit-bombay.png"
                                                                                  title="IIT Bombay" height="70"
                                                                                  width="70"></a></div>
                        <div><a target="_blank" href="http://www.iitk.ac.in"><img src="logos/IIT_Kanpur_Logo.png"
                                                                                  title="IIT Kanpur" height="70"
                                                                                  width="70"></a></div>
                        <div><a target="_blank" href="http://www.iith.ac.in"><img src="logos/iit_hydrabad_logo.png"
                                                                                  title="IIT Hydrabad" height="70"
                                                                                  width="70"></a></div>
                        <div><a target="_blank" href="http://www.iitbhu.ac.in"><img src="logos/iiit-varanasi.png"
                                                                                    title="IIT Varanasi(BHU)"
                                                                                    height="70" width="70"></a></div>
                        <div><a target="_blank" href="http://www.iitbbs.ac.in"><img src="logos/bhuvneshwar.png"
                                                                                    title="IIT Bhuvneshwar" height="70"
                                                                                    width="70"></a></div>
                        <div><a target="_blank" href="http://www.iitkgp.ac.in"><img src="logos/IITKharagpurLogo.png"
                                                                                    title="IIT Kharagpur" height="70"
                                                                                    width="70"></a></div>
                    </div>
                </div>
            </div>
