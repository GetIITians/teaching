...
<html>
	...
	<body onload="submitPayuForm()">
		<form action="<?php echo $action; ?>" method="post" name="payuForm">
			...
			<input type="hidden" name="surl" value="<?php echo 'http://localhost/teaching/PayUMoney/success.php'; ?>" />
			<input type="hidden" name="furl" value="<?php echo 'http://localhost/teaching/PayUMoney/failure.php'; ?>" />
